...
{
    public class CategoryAnalyzeToFile : AnalyzeToTextbaseFileBase
    {
        ...
        protected override string GetResultText()
        {
            ...
            csvStringGenerator.AppendColumn("name").AppendColumn("sum(msec)").AppendColumn("call").
                AppendColumn("min(msec)").AppendColumn("max(msec)").NextRow();
