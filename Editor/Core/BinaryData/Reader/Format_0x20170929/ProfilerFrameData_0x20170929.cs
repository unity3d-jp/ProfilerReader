...
namespace UTJ.ProfilerReader
{
    namespace BinaryData
    {
        ...
        {
            internal bool Read_0x20170929(System.IO.Stream stream, int frameSize, int threadCount, int index)
            {
                ...
                allStats.Read_0x20170929(stream);
                ...
                for (int i = 0; i < m_ThreadCount; ++i)
                {
                    ...
                    threadData.Read_0x20170929(stream);
