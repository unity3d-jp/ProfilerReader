...
namespace UTJ.ProfilerReader
{
    namespace BinaryData
    {
        ...
        {
            internal bool Read_0x20160622(System.IO.Stream stream, int frameSize, int threadCount, int index)
            {
                ...
                allStats.Read_0x20160622(stream);
                ...
                for( int i = 0 ; i < audioIncentanceGroupInfoNum; ++ i ){
                    ...
                    audioGroupInfo.Read_0x20160622( stream);
                ...
                for( int i = 0 ; i < audioDspInfoNum; ++ i){
                    ...
                    dspInfo.Read_0x20160622(stream);
                ...
                for (int i = 0; i < clipInfoNum; ++i)
                {
                    ...
                    clipInfo.Read_0x20160622(stream);
                ...
                for (int i = 0; i < m_ThreadCount; ++i)
                {
                    ...
                    threadData.Read_0x20160622(stream);
